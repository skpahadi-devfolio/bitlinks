  ...
  return (
    <main className="bg-purple-300">
      <section className="grid grid-cols-2 md:h-[50vh] h-[120vh]">
        ...
        <p className="md:px-28 px-2 text-left md:text-center">We are the most straightforward URL Shortener in the world. Most of the url Shorteners will track you or ask you to give your details for login. We understand your needs and hence we have created this URL Shortener.</p>
        ...
        <div className="flex justify-start absolute md:right-48 -right-14">
